...
if (!isset($_GET['usuario_id']) || !is_numeric($_GET['usuario_id']) || !isset($_GET['curso_id']) || !is_numeric($_GET['curso_id'])) {
...
if (class_exists('Login') && method_exists('login', 'getInscripcionInfo')) {
    $usuario_info = Login::getInscripcionInfo($usuario_id, $curso_id);
} else {
            ...
            <?php if (is_array($usuario_info) && count($usuario_info) > 0): ?>
                <div class="row" style="border: 1px solid white; padding:10px; border-radius:15px;">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-8"><?php echo htmlspecialchars($usuario_info['nombre'], ENT_QUOTES, 'UTF-8'); ?>
                        </div>
                    </div>
                    <div class="row mb-2">
                        <div class="col-sm-4"><strong>Correo:</strong></div>
                        <div class="col-sm-8"><?php echo htmlspecialchars($usuario_info['correo'], ENT_QUOTES, 'UTF-8'); ?>
                        </div>
                    </div>
                    <div class="row mb-2">
                        <div class="col-sm-4"><strong>Curso:</strong></div>
                        <div class="col-sm-8">
                            <?php echo htmlspecialchars($usuario_info['curso_id'], ENT_QUOTES, 'UTF-8'); ?>
                        </div>
                    </div>
                </div>
